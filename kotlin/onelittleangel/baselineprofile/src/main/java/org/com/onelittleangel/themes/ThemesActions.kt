package org.com.onelittleangel.themes
...
fun MacrobenchmarkScope.themesWaitForContent() {
    ...
    val obj = device.findObject(By.res("themes:feed"))
...
fun MacrobenchmarkScope.themesScrollFeedDownUp() {
    val feedList = device.findObject(By.res("themes:feed"))
