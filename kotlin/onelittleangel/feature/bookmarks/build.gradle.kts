...
multiplatformResources {
    multiplatformResourcesPackage = "com.onelittleangel.bookmarks" // required
...
kotlin {
    ...
    listOf(
        ...
        it.binaries.framework {
            baseName = "bookmarks"
            isStatic = true
            binaryOption("bundleId", "com.onelittleangel.bookmarks")
        }
    }
...
android {
    namespace = "com.onelittleangel.bookmarks"
    compileSdk = 34
    defaultConfig {
        minSdk = 24
    }
