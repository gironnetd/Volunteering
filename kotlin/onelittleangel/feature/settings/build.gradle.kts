...
multiplatformResources {
    multiplatformResourcesPackage = "com.onelittleangel.settings" // required
...
kotlin {
    ...
    listOf(
        ...
        it.binaries.framework {
            baseName = "settings"
            isStatic = true
            binaryOption("bundleId", "com.onelittleangel.settings")
        }
    }
...
android {
    namespace = "com.onelittleangel.settings"
    compileSdk = 34
    defaultConfig {
        minSdk = 24
    }
