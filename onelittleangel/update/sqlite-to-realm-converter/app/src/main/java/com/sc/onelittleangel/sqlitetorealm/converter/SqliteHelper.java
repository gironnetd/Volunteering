...
public class SqliteHelper extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME ="onelittleangelen.sqlite";
...
//        return false;
    ...
    public List<List<String>> getRecords(String tableName){
        ...
        if(tableName.equals("author_default"))
            cursor = reader.rawQuery("SELECT * FROM " + tableName + " WHERE book = 0",null);
        else if (tableName.equals("book"))
            cursor = reader.rawQuery("SELECT * FROM author_default WHERE book = 1",null);
        else
            cursor = reader.rawQuery("SELECT * FROM " + tableName,null);
