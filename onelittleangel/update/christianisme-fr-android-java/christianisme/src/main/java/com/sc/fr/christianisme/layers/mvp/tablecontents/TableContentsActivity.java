package com.sc.fr.christianisme.layers.mvp.tablecontents;
...
import com.sc.fr.christianisme.layers.dao.themes.ThemesDaoInterface;
...
import com.sc.fr.christianisme.layers.mvp.common.customs.typefaces.PersonalTypefaceSpan;
import com.sc.fr.christianisme.layers.mvp.common.customs.viewpagers.fragmentpageradapter.FragmentNativePagerAdapter;
...
import com.sc.fr.christianisme.layers.mvp.tablecontents.fragments.homepage.adapters.listadapters.HomePageListAdapter;
...
import com.sc.fr.christianisme.layers.mvp.common.layouts.smarttablayouts.SmartTabLayout;
...
public class TableContentsActivity extends MotherActivity implements TableContentsViewInterface, ObservableScrollView.Callbacks, ImageViewListener.Callbacks, HomePageFragment.Callbacks {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Theme citationsTheme = themesDaoInterface.findThemeByIdTheme(139);

    if (citationsTheme != null) citationsTheme.deleteFromRealm();

    Theme sagesseTheme = themesDaoInterface.findThemeByIdTheme(129);

    if (sagesseTheme != null) sagesseTheme.deleteFromRealm();
...
//editor.commit();
    ...
    if(settings.getString(Constants.TYPEFACE, "").equals("")){
      editor.putString(Constants.TYPEFACE, "IMFellEnglish-Regular");
//editor.commit();
      editor.apply();    }
    ...
    font = Typeface.createFromAsset(getAssets(), "fonts/Monotype-Corsiva-Regular.ttf");
