...
package com.sc.fr.confucianisme.layers.mvp.settings.fragments.notifications.picker.time;
...
import com.sc.fr.confucianisme.layers.mvp.settings.fragments.notifications.picker.TypefaceHelper;
import com.sc.fr.confucianisme.layers.mvp.settings.fragments.notifications.picker.Utils;
import com.sc.fr.confucianisme.R;
import com.sc.fr.confucianisme.layers.mvp.settings.fragments.notifications.picker.HapticFeedbackController;
  ...
  RadialPickerLayout.OnValueSelectedListener, TimePickerController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // mOkButton.setOnClickListener(mOnConfirmListener);
        ...
        mOkButton.setTypeface(TypefaceHelper.get(context, "IM_Fell_English"));
        ...
        mCancelButton.setTypeface(TypefaceHelper.get(context, "IM_Fell_English"));
