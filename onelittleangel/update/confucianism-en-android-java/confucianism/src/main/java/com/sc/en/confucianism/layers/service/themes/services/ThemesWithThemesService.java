package com.sc.en.confucianism.layers.service.themes.services;
...
import com.sc.en.confucianism.transverse.eventbus.events.themes.ThemesWithThemesLoadedEvent;
...
public class ThemesWithThemesService extends MotherBusinessService implements ThemesWithThemesServiceInterface {
   ...
   *
   */
  private List<com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme> themes = null;
...
//    }
  ...
  private List<com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme> convertToThemes(List<com.sc.en.confucianism.transverse.orms.realm.models.Theme> themesWithThemes){
    ...
    if (themesWithThemes != null) {
      for (int i = 0; i < themesWithThemes.size(); i++) {
        ...
        com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme mMainTheme = new com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme();
        ...
        if (themesWithThemes.get(i).getThemes() != null) {
          for (int j = 0; j < themesWithThemes.get(i).getThemes().size(); j++) {
            ...
            if (themesWithThemes.get(i).getThemes().get(j).getNbQuotes() == 0) {
              ...
              com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme mSecondTheme = new com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme();
   ...
   */
  private void postThemesWithThemesLoadedEvent(List<com.sc.en.confucianism.layers.mvp.tablecontents.models.Theme> themesWithThemes) {
