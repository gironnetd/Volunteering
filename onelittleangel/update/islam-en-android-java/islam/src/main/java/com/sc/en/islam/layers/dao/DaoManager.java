package com.sc.en.islam.layers.dao;

import com.sc.en.islam.layers.dao.accounts.AccountsDao;
import com.sc.en.islam.layers.dao.accounts.AccountsDaoInterface;
import com.sc.en.islam.layers.dao.authors.AuthorsDao;
import com.sc.en.islam.layers.dao.authors.AuthorsDaoInterface;
import com.sc.en.islam.layers.dao.books.BooksDao;
import com.sc.en.islam.layers.dao.books.BooksDaoInterface;
import com.sc.en.islam.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.en.islam.layers.dao.movements.MovementsDaoInterface;
import com.sc.en.islam.layers.dao.pictures.PicturesDao;
import com.sc.en.islam.layers.dao.pictures.PicturesDaoInterface;
import com.sc.en.islam.layers.dao.presentations.PresentationsDao;
import com.sc.en.islam.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.en.islam.layers.dao.quotes.QuotesDao;
import com.sc.en.islam.layers.dao.quotes.QuotesDaoInterface;
import com.sc.en.islam.layers.dao.themes.ThemesDao;
import com.sc.en.islam.layers.dao.themes.ThemesDaoInterface;
import com.sc.en.islam.layers.dao.urls.UrlsDao;
import com.sc.en.islam.layers.dao.urls.UrlsDaoInterface;
import com.sc.en.islam.layers.dao.centuries.CenturiesDao;
import com.sc.en.islam.layers.dao.movements.MovementsDao;
