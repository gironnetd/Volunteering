package com.sc.fr.taoisme.layers.mvp.common.customs.listviews.adapters;
 ...
 */
public class MailsAddedRecyclerAdapter extends RecyclerView.Adapter<MailsAddedRecyclerAdapter.mViewHolder> {
    ...
    public final ArrayMap<String, String> contacts;
  public List<mViewHolder> holders;
    private SharedPreferences settings;
    //SharedPreferences.Editor editor;

  private String movementsList = "";
    public WeakReference<SoundPool> soundPool;

    public MailsAddedRecyclerAdapter(Context context, ArrayMap<String, String> contacts) {
    ...
    public MailsAddedRecyclerAdapter(ArrayMap<String, String> contacts) {
        this.contacts = contacts;
    }
    ...
    public mViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.mail_added_dialog_row, parent, false);
    ...
    public void onBindViewHolder(mViewHolder holder, int position) {
        ...
        holder.ivRemove.setOnClickListener(v -> {
            movementsList = settings.getString(Constants.MAILS_ADDED_LIST, "");
            movementsList = movementsList.replace(contacts.keyAt(position) + ";", "");
            settings.edit().putString(Constants.MAILS_ADDED_LIST, movementsList).apply();
            movementsList = settings.getString(Constants.MAILS_LIST_TO_SEND, "");
            movementsList = movementsList.replace(contacts.keyAt(position) + ";", "");
    ...
    public class mViewHolder extends RecyclerView.ViewHolder implements View.OnTouchListener {

        public int position;
        final TextViewNative fontName;
        // final Button button;
        public final ImageView fontCb, ivRemove;
        final MailsAddedRecyclerAdapter adapter;

        mViewHolder(View itemView, MailsAddedRecyclerAdapter adapter) {
            super(itemView);
