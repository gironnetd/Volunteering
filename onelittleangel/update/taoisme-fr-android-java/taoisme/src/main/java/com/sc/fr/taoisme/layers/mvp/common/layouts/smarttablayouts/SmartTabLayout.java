 ...
 */
package com.sc.fr.taoisme.layers.mvp.common.layouts.smarttablayouts;
...
import com.sc.fr.taoisme.layers.mvp.tablecontents.fragments.authors.AuthorsFragment;
import com.sc.fr.taoisme.layers.mvp.tablecontents.fragments.books.BooksFragment;
import com.sc.fr.taoisme.layers.mvp.tablecontents.fragments.homepage.fragments.HomePageFragment;
import com.sc.fr.taoisme.layers.mvp.tablecontents.fragments.movements.MovementsFragment;
import com.sc.fr.taoisme.layers.mvp.tablecontents.fragments.themes.ThemesFragment;
...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  private SharedPreferences settings = getContext().getSharedPreferences(TableContentsActivity.PREFS_NAME, 0);
  ...
  private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
    ...
    public void onPageScrollStateChanged(int state) {
      ...
      if (scrollState == ViewPager.SCROLL_STATE_IDLE) {
        ...
        switch (mCurrentPosition) {
          case 0:
            TableContentsActivity.fromFragment = getResources().getString(R.string.homepage);
            //  HomePageFragment homePageFragment = (HomePageFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
            break;
          case 1:
            //  AuthorsFragment authorsFragment = (AuthorsFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
            TableContentsActivity.fromFragment = getResources().getString(R.string.authors);
            break;
          case 2:
            TableContentsActivity.fromFragment = getResources().getString(R.string.movements);
            //  MovementsFragment movementsFragment = (MovementsFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
            break;
          case 3:
            TableContentsActivity.fromFragment = getResources().getString(R.string.themes);
            //  ThemesFragment themesFragment = (ThemesFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
            break;
          case 4:
            TableContentsActivity.fromFragment = getResources().getString(R.string.books);
            //  BooksFragment booksFragment = (BooksFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
            break;
        }
    ...
    public void onPageSelected(int position) {
      ...
      if (TableContentsActivity.fromFragment != null && TableContentsActivity.fromFragment.equals(getResources().getString(R.string.homepage))) {
        TableContentsActivity.fromFragment = null;
      }
      ...
      switch (position) {
        case 0:
          TableContentsActivity.fromFragment = getResources().getString(R.string.homepage);
          HomePageFragment homePageFragment = (HomePageFragment) viewPager.adapter.getFragments().get(position);
          if (!TableContentsActivity.isFromOtherActivity) {
        ...
        case 1:
          TableContentsActivity.fromFragment = getResources().getString(R.string.authors);
          AuthorsFragment authorsFragment = (AuthorsFragment) viewPager.adapter.getFragments().get(position);
          if (!TableContentsActivity.isFromOtherActivity) {
            authorsFragment.setUserVisibleHint(true);
          }
          break;
        case 2:
          TableContentsActivity.fromFragment = getResources().getString(R.string.movements);
        ...
        case 3:
          TableContentsActivity.fromFragment = getResources().getString(R.string.themes);
          ThemesFragment themesFragment = (ThemesFragment) viewPager.adapter.getFragments().get(position);
          if (!TableContentsActivity.isFromOtherActivity) {
            themesFragment.setUserVisibleHint(true);
          }
          break;
        case 4:
          TableContentsActivity.fromFragment = getResources().getString(R.string.books);
          BooksFragment booksFragment = (BooksFragment) viewPager.adapter.getFragments().get(position);
          if (!TableContentsActivity.isFromOtherActivity) {
            booksFragment.setUserVisibleHint(true);
          }
          break;
      }
      ...
      switch (mCurrentPosition) {
        ...
        case 1:
          AuthorsFragment authorsFragment = (AuthorsFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
          authorsFragment.setUserVisibleHint(false);
          break;
        case 2:
          MovementsFragment movementsFragment = (MovementsFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
          movementsFragment.setUserVisibleHint(false);
          break;
        case 3:
          ThemesFragment themesFragment = (ThemesFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
          themesFragment.setUserVisibleHint(false);
          break;
        case 4:
          BooksFragment booksFragment = (BooksFragment) viewPager.adapter.getFragments().get(mCurrentPosition);
          booksFragment.setUserVisibleHint(false);
          break;
      }
      ...
      if (settings == null) settings = OnelittleAngelApplication.instance.getSharedPreferences(TableContentsActivity.PREFS_NAME, 0);
      //if (editor == null) editor = settings.edit();
      boolean isAfterRotation = isOnPageSelected;
