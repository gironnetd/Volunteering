package com.sc.fr.taoisme.layers.dao;

import com.sc.fr.taoisme.layers.dao.accounts.AccountsDao;
import com.sc.fr.taoisme.layers.dao.accounts.AccountsDaoInterface;
import com.sc.fr.taoisme.layers.dao.authors.AuthorsDao;
import com.sc.fr.taoisme.layers.dao.authors.AuthorsDaoInterface;
import com.sc.fr.taoisme.layers.dao.books.BooksDao;
import com.sc.fr.taoisme.layers.dao.books.BooksDaoInterface;
import com.sc.fr.taoisme.layers.dao.centuries.CenturiesDao;
import com.sc.fr.taoisme.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.fr.taoisme.layers.dao.movements.MovementsDao;
import com.sc.fr.taoisme.layers.dao.movements.MovementsDaoInterface;
import com.sc.fr.taoisme.layers.dao.pictures.PicturesDao;
import com.sc.fr.taoisme.layers.dao.pictures.PicturesDaoInterface;
import com.sc.fr.taoisme.layers.dao.presentations.PresentationsDao;
import com.sc.fr.taoisme.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.fr.taoisme.layers.dao.quotes.QuotesDao;
import com.sc.fr.taoisme.layers.dao.quotes.QuotesDaoInterface;
import com.sc.fr.taoisme.layers.dao.themes.ThemesDao;
import com.sc.fr.taoisme.layers.dao.themes.ThemesDaoInterface;
import com.sc.fr.taoisme.layers.dao.urls.UrlsDao;
