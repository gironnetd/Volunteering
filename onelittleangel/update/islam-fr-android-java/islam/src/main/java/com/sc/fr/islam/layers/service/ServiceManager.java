package com.sc.fr.islam.layers.service;

import android.support.annotation.NonNull;
import android.util.Log;

import com.sc.fr.islam.layers.service.accounts.interfaces.FaceBookServiceInterface;
import com.sc.fr.islam.layers.service.accounts.interfaces.GooglePlusServiceInterface;
import com.sc.fr.islam.layers.service.accounts.interfaces.TwitterServiceInterface;
import com.sc.fr.islam.layers.service.accounts.services.FaceBookService;
import com.sc.fr.islam.layers.service.accounts.services.GooglePlusService;
import com.sc.fr.islam.layers.service.authors.interfaces.AuthorsAllServiceInterface;
import com.sc.fr.islam.layers.service.authors.interfaces.AuthorsByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.authors.interfaces.AuthorsByIdThemeServiceInterface;
import com.sc.fr.islam.layers.service.authors.services.AuthorByNameService;
import com.sc.fr.islam.layers.service.authors.services.AuthorsByIdMovementService;
import com.sc.fr.islam.layers.service.authors.services.AuthorsByIdThemeService;
import com.sc.fr.islam.layers.service.books.interfaces.BookByNameServiceInterface;
import com.sc.fr.islam.layers.service.books.interfaces.BooksAllServiceInterface;
import com.sc.fr.islam.layers.service.books.services.BooksByIdThemeService;
import com.sc.fr.islam.layers.service.centuries.interfaces.CenturyByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.centuries.interfaces.CenturyByIdCenturyServiceInterface;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementsAllServiceInterface;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementsWithMovementsServiceInterface;
import com.sc.fr.islam.layers.service.movements.services.MovementByNameService;
...
import com.sc.fr.islam.layers.service.pictures.interfaces.PictureByIdPictureServiceInterface;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesAllServiceInterface;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesByIdAuthorServiceInterface;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.pictures.services.PictureByIdPictureService;
import com.sc.fr.islam.layers.service.pictures.services.PicturesByIdBookService;
import com.sc.fr.islam.layers.service.pictures.services.PicturesByIdMovementService;
import com.sc.fr.islam.layers.service.presentations.interfaces.PresentationByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.presentations.interfaces.PresentationsAllServiceInterface;
import com.sc.fr.islam.layers.service.presentations.services.PresentationByIdPresentationService;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByAuthorServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.UpdateQuoteServiceInterface;
import com.sc.fr.islam.layers.service.quotes.services.FavoritesQuotesService;
import com.sc.fr.islam.layers.service.quotes.services.QuoteByIdQuoteService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByMovementService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByThemeService;
import com.sc.fr.islam.layers.service.quotes.services.UpdateQuoteService;
import com.sc.fr.islam.layers.service.themes.interfaces.ThemesByIdParentServiceInterface;
import com.sc.fr.islam.layers.service.themes.services.ThemeByIdThemeService;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlByIdUrlServiceInterface;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsByIdAuthorserviceInterface;
import com.sc.fr.islam.layers.service.urls.services.UrlByIdUrlService;
import com.sc.fr.islam.layers.service.urls.services.UrlsAllService;
import com.sc.fr.islam.layers.service.urls.services.UrlsByIdBookService;
import com.sc.fr.islam.layers.service.urls.services.UrlsByIdMovementService;
import com.sc.fr.islam.layers.service.urls.services.UrlsBySourceTypeService;
import com.sc.fr.islam.BuildConfig;
import com.sc.fr.islam.OnelittleAngelApplication;
import com.sc.fr.islam.layers.service.accounts.interfaces.MailServiceInterface;
import com.sc.fr.islam.layers.service.accounts.services.MailService;
import com.sc.fr.islam.layers.service.accounts.services.TwitterService;
import com.sc.fr.islam.layers.service.homepage.interfaces.HomePageServiceInterface;
import com.sc.fr.islam.layers.service.homepage.services.HomePageService;
import com.sc.fr.islam.layers.service.mails.interfaces.MailsServiceInterface;
import com.sc.fr.islam.layers.service.mails.services.MailsService;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementsWithAuthorsServiceInterface;
import com.sc.fr.islam.layers.service.notifications.biographyofday.services.BiographyNotificationService;
import com.sc.fr.islam.layers.service.notifications.pictureofday.interfaces.PictureNotificationIntentServiceInterface;
import com.sc.fr.islam.layers.service.notifications.pictureofday.services.PictureNotificationService;
import com.sc.fr.islam.layers.service.notifications.quoteofday.interfaces.QuoteNotificationIntentServiceInterface;
import com.sc.fr.islam.layers.service.notifications.quoteofday.services.QuoteNotificationService;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesForCarouselInterface;
import com.sc.fr.islam.layers.service.pictures.services.PicturesForCarousel;
import com.sc.fr.islam.layers.service.quotes.interfaces.FavoritesQuotesServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByBookServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByMovementServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByThemeServiceInterface;
import com.sc.fr.islam.layers.service.quotes.services.QuotesAllService;
import com.sc.fr.islam.layers.service.authors.interfaces.AuthorByIdAuthorServiceInterface;
import com.sc.fr.islam.layers.service.authors.interfaces.AuthorByNameServiceInterface;
import com.sc.fr.islam.layers.service.authors.services.AuthorByIdAuthorService;
import com.sc.fr.islam.layers.service.authors.services.AuthorsAllService;
import com.sc.fr.islam.layers.service.books.interfaces.BookByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.books.interfaces.BooksByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.books.interfaces.BooksByIdThemeServiceInterface;
import com.sc.fr.islam.layers.service.books.services.BookByIdBookService;
import com.sc.fr.islam.layers.service.books.services.BookByNameService;
import com.sc.fr.islam.layers.service.books.services.BooksAllService;
import com.sc.fr.islam.layers.service.books.services.BooksByIdMovementService;
import com.sc.fr.islam.layers.service.centuries.interfaces.CenturiesAllServiceInterface;
import com.sc.fr.islam.layers.service.centuries.interfaces.CenturyByIdAuthorServiceInterface;
import com.sc.fr.islam.layers.service.centuries.interfaces.CenturyByNameServiceInterface;
import com.sc.fr.islam.layers.service.centuries.services.CenturiesAllService;
import com.sc.fr.islam.layers.service.centuries.services.CenturyByIdAuthorService;
import com.sc.fr.islam.layers.service.centuries.services.CenturyByIdBookService;
import com.sc.fr.islam.layers.service.centuries.services.CenturyByIdCenturyService;
import com.sc.fr.islam.layers.service.centuries.services.CenturyByNameService;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementByNameServiceInterface;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementsByIdParentServiceInterface;
import com.sc.fr.islam.layers.service.movements.interfaces.MovementsWithBooksServiceInterface;
import com.sc.fr.islam.layers.service.movements.services.MovementByIdMovementService;
import com.sc.fr.islam.layers.service.movements.services.MovementsAllService;
import com.sc.fr.islam.layers.service.movements.services.MovementsByIdParentService;
import com.sc.fr.islam.layers.service.movements.services.MovementsWithAuthorsService;
import com.sc.fr.islam.layers.service.movements.services.MovementsWithBooksService;
import com.sc.fr.islam.layers.service.movements.services.MovementsWithMovementsService;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesByIdThemeServiceInterface;
import com.sc.fr.islam.layers.service.pictures.interfaces.PicturesByNameSmallServiceInterface;
import com.sc.fr.islam.layers.service.pictures.services.PicturesAllService;
import com.sc.fr.islam.layers.service.pictures.services.PicturesByIdAuthorService;
import com.sc.fr.islam.layers.service.pictures.services.PicturesByIdThemeService;
import com.sc.fr.islam.layers.service.pictures.services.PicturesByNameSmallService;
import com.sc.fr.islam.layers.service.presentations.interfaces.PresentationByIdAuthorServiceInterface;
import com.sc.fr.islam.layers.service.presentations.interfaces.PresentationByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.presentations.interfaces.PresentationByIdPresentationServiceInterface;
import com.sc.fr.islam.layers.service.presentations.services.PresentationByIdAuthorService;
import com.sc.fr.islam.layers.service.presentations.services.PresentationByIdBookService;
import com.sc.fr.islam.layers.service.presentations.services.PresentationByIdMovementService;
import com.sc.fr.islam.layers.service.presentations.services.PresentationsAllService;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuoteByIdQuoteServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesAllServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByIdAuthorServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.quotes.interfaces.QuotesByIdThemeServiceInterface;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByAuthorService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByBookService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByIdAuthorService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByIdBookService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByIdMovementService;
import com.sc.fr.islam.layers.service.quotes.services.QuotesByIdThemeService;
import com.sc.fr.islam.layers.service.themes.interfaces.ThemeByIdThemeServiceInterface;
import com.sc.fr.islam.layers.service.themes.interfaces.ThemeByNameServiceInterface;
import com.sc.fr.islam.layers.service.themes.interfaces.ThemesAllServiceInterface;
import com.sc.fr.islam.layers.service.themes.interfaces.ThemesWithThemesServiceInterface;
import com.sc.fr.islam.layers.service.themes.services.ThemeByNameService;
import com.sc.fr.islam.layers.service.themes.services.ThemesAllService;
import com.sc.fr.islam.layers.service.themes.services.ThemesByIdParentService;
import com.sc.fr.islam.layers.service.themes.services.ThemesWithThemesService;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsAllServiceInterface;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsByIdBookServiceInterface;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsByIdMovementServiceInterface;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsByIdSourceServiceInterface;
import com.sc.fr.islam.layers.service.urls.interfaces.UrlsBySourceTypeServiceInterface;
import com.sc.fr.islam.layers.service.urls.services.UrlsByIdAuthorService;
import com.sc.fr.islam.layers.service.urls.services.UrlsByIdSourceService;
