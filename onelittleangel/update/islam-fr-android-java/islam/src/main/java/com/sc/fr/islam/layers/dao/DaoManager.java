package com.sc.fr.islam.layers.dao;

import com.sc.fr.islam.layers.dao.accounts.AccountsDao;
import com.sc.fr.islam.layers.dao.accounts.AccountsDaoInterface;
import com.sc.fr.islam.layers.dao.authors.AuthorsDao;
import com.sc.fr.islam.layers.dao.authors.AuthorsDaoInterface;
import com.sc.fr.islam.layers.dao.books.BooksDao;
import com.sc.fr.islam.layers.dao.books.BooksDaoInterface;
import com.sc.fr.islam.layers.dao.centuries.CenturiesDao;
import com.sc.fr.islam.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.fr.islam.layers.dao.movements.MovementsDao;
import com.sc.fr.islam.layers.dao.movements.MovementsDaoInterface;
import com.sc.fr.islam.layers.dao.pictures.PicturesDao;
import com.sc.fr.islam.layers.dao.pictures.PicturesDaoInterface;
import com.sc.fr.islam.layers.dao.presentations.PresentationsDao;
import com.sc.fr.islam.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.fr.islam.layers.dao.quotes.QuotesDao;
import com.sc.fr.islam.layers.dao.quotes.QuotesDaoInterface;
import com.sc.fr.islam.layers.dao.themes.ThemesDao;
import com.sc.fr.islam.layers.dao.themes.ThemesDaoInterface;
import com.sc.fr.islam.layers.dao.urls.UrlsDao;
import com.sc.fr.islam.layers.dao.urls.UrlsDaoInterface;
