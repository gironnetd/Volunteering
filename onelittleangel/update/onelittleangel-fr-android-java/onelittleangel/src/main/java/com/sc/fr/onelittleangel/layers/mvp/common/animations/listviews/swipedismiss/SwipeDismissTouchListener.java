package com.sc.fr.onelittleangel.layers.mvp.common.animations.listviews.swipedismiss;
...
/**
 * A {@link OnTouchListener} that makes any {@link View} dismissable when the
...
class SwipeDismissTouchListener implements OnTouchListener {
    ...
    switch (motionEvent.getActionMasked()) {
      ...
      case MotionEvent.ACTION_MOVE:
        ...
        if (mSwiping) {
          ...
          ViewHelper.setTranslationX(mView, deltaX - mSwipingSlop);
  ...
  private void performDismiss() {
    ...
    final LayoutParams lp = mView.getLayoutParams();
