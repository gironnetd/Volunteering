...
package com.sc.fr.onelittleangel.layers.mvp.settings.fragments.notifications.picker.time;
...
import com.sc.fr.onelittleangel.layers.mvp.settings.fragments.notifications.picker.HapticFeedbackController;
import com.sc.fr.onelittleangel.layers.mvp.settings.fragments.notifications.picker.TypefaceHelper;
import com.sc.fr.onelittleangel.layers.mvp.settings.fragments.notifications.picker.Utils;
...
public class TimePickerDialog extends DialogFragment implements
  RadialPickerLayout.OnValueSelectedListener, TimePickerController {
    ...
    public void setmUnselectedColor(int mUnselectedColor) {
        this.mUnselectedColor = mUnselectedColor;
    }

    public Timepoint getmInitialTime() {
        return mInitialTime;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // mOkButton.setOnClickListener(mOnConfirmListener);
        ...
        mOkButton.setTypeface(TypefaceHelper.get(context, "SortsMillGoudy-Italic"));
        ...
        mCancelButton.setTypeface(TypefaceHelper.get(context, "SortsMillGoudy-Italic"));
