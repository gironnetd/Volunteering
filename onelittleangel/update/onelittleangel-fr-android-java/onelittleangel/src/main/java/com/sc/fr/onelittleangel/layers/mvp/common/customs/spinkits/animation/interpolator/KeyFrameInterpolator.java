package com.sc.fr.onelittleangel.layers.mvp.common.customs.spinkits.animation.interpolator;
...
public class KeyFrameInterpolator implements Interpolator {
    ...
    public static KeyFrameInterpolator pathInterpolator(float... fractions) {
        KeyFrameInterpolator interpolator = new KeyFrameInterpolator(PathInterpolatorCompat.create(0.21f, 0.53f, 0.56f, 0.8f));
        interpolator.setFractions(fractions);
        return interpolator;
    }
