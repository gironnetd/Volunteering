...
import com.sc.fr.onelittleangel.layers.mvp.tablecontents.models.base.adapters.recycleradapters.BaseRecyclerAdapter.BaseRecyclerViewHolder;
...
public class Utils {
  ...
  public static void toggle(Activity activity, final int position, final String modelsName,
                            ...
                            final BaseRecyclerViewHolder mParentBaseRecyclerViewHolder,
                            final BaseRecyclerViewHolder mBaseRecyclerViewHolder,
                            final int duration) {
                    ...
                    for (int i = 0; i < mBaseListAdapter.holders.size(); i++) {
                      ...
                      if (viewHolder.isExpanded) {
                        ...
                        for (int j = 0; j < adapter.holders.size(); j++) {
                          BaseRecyclerViewHolder recyclerViewHolder = (BaseRecyclerViewHolder) adapter.holders.get(j);
                                  ...
                                  for (int i1 = 0; i1 < mBaseListAdapter.holders.size(); i1++) {
                                    ...
                                    if (viewHolder1.isExpanded) {
                                      ...
                                      for (int j = 0; j < adapter1.holders.size(); j++) {
                                        BaseRecyclerViewHolder recyclerViewHolder = (BaseRecyclerViewHolder) adapter1.holders.get(j);
                                        if (recyclerViewHolder.isExpanded) {
