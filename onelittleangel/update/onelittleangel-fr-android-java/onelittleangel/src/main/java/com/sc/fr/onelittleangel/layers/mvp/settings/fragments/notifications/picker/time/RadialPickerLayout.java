...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            ViewPropertyAnimator.animate(mHourRadialTextsView).alpha(hourAlpha);
            ViewPropertyAnimator.animate(mHourRadialSelectorView).alpha(hourAlpha);
            ViewPropertyAnimator.animate(mMinuteRadialTextsView).alpha(minuteAlpha);
            ViewPropertyAnimator.animate(mMinuteRadialSelectorView).alpha(minuteAlpha);
            ViewPropertyAnimator.animate(mSecondRadialTextsView).alpha(secondAlpha);
            ViewPropertyAnimator.animate(mSecondRadialSelectorView).alpha(secondAlpha);
