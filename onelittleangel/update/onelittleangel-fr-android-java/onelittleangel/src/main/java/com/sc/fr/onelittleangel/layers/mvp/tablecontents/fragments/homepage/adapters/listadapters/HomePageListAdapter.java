package com.sc.fr.onelittleangel.layers.mvp.tablecontents.fragments.homepage.adapters.listadapters;
...
import com.sc.fr.onelittleangel.layers.mvp.common.animations.listviews.ArrayAdapter;
...
import com.sc.fr.onelittleangel.layers.mvp.tablecontents.fragments.homepage.fragments.HomePageFragment;
import com.sc.fr.onelittleangel.layers.mvp.tablecontents.fragments.homepage.fragments.HomePagePresenterInterface;
import com.sc.fr.onelittleangel.layers.mvp.tablecontents.fragments.homepage.views.cardviews.HomePageCardView;
import com.sc.fr.onelittleangel.layers.mvp.tablecontents.fragments.homepage.views.listviews.HomePageListView;
...
//      if(presenter == null) presenter = fragment.presenter;
      ...
      if (position == 0) {
        ...
        holder.link.setText(presenter.getQuoteOfDay().getAuthor() != null ? "[ " + OnelittleAngelApplication.instance.getResources().getString(R.string.more_quotes) + presenter.getQuoteOfDay().getAuthor().getMcc1() + " " + presenter.getQuoteOfDay().getAuthor().getName() + " ] " : " [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.more_quotes) + presenter.getQuoteOfDay().getBook().getMcc1() + " " + presenter.getQuoteOfDay().getBook().getName() + " ] ");
...
//          holder.name.setText(String.format("%s ", presenter.getNamePictureOfDay()));
          ...
          if (presenter.getAuthorPictureOfDay() != null  && presenter.getAuthorPictureOfDay().getName() != null) {
            ...
            if (presenter.getAuthorPictureOfDay().getQuotes().size() != 0) {
              holder.link.setText(" [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.quotes_of) +  presenter.getAuthorPictureOfDay().getMcc1() + " " + presenter.getAuthorPictureOfDay().getName() + " ] ");
              ...
              holder.link.setText(" [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.biography_of) + presenter.getAuthorPictureOfDay().getMcc1() + " " + presenter.getAuthorPictureOfDay().getName() + " ] ");
          ...
          if (presenter.getBookPictureOfDay().getName() != null) {
            ...
            if (presenter.getBookPictureOfDay().getQuotes().size() != 0) {
              holder.link.setText(" [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.quotes_of) + presenter.getBookPictureOfDay().getMcc1() + " " + presenter.getBookPictureOfDay().getName() + " ] ");
              ...
              holder.link.setText(" [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.history_of) + presenter.getBookPictureOfDay().getMcc1() + " " + presenter.getBookPictureOfDay().getName() + " ] ");
      ...
      if (position == 2) {
        ...
        if (presenter.getAuthorPresentationOfDay() != null) {
          ...
          holder.link.setText(" [ " + OnelittleAngelApplication.instance.getResources().getString(R.string.biography_of) + presenter.getBookPresentationOfDay().getMcc1() + " " + presenter.getBookPresentationOfDay().getName() + " ] ");
