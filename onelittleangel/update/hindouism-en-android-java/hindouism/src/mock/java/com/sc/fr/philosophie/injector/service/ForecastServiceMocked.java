 ...
 */
public class ForecastServiceMocked {
//
//    implements ForecastServiceIntf {
//    /**
...
//        CityForecastLoadedEvent cityForecastLoadedEvent= new CityForecastLoadedEvent(DataGenerator.getCityForecast(cityId),cityId);
...
//        CityForecastLoadedEvent cityForecastLoadedEvent= new CityForecastLoadedEvent(event.getCityForecast(),event.getCityId());
//        EventBus.getDefault().post(cityForecastLoadedEvent);
//    }
//
//    /**
