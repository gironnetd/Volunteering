...
import com.sc.en.hindouism.layers.mvp.common.customs.typefaces.PersonalTypefaceSpan;
import com.sc.en.hindouism.layers.mvp.common.customs.viewpagers.ViewPagerNative;
import com.sc.en.hindouism.layers.mvp.common.customs.viewpagers.fragmentpageradapter.FragmentNativePagerAdapter;
...
import com.sc.en.hindouism.layers.mvp.tablecontents.fragments.homepage.adapters.listadapters.HomePageListAdapter;
...
//          homePageDialog.setCancelable(false);
  ...
  public void confirmAddRemoveDialog() {
    ...
    presenter.toggleQuoteOfDayIsFavorites((int) homePageFragment.presenter.getQuoteOfDay().getIdQuote());
