package com.sc.en.taoism.layers.dao;

import com.sc.en.taoism.layers.dao.authors.AuthorsDao;
import com.sc.en.taoism.layers.dao.books.BooksDaoInterface;
import com.sc.en.taoism.layers.dao.centuries.CenturiesDao;
import com.sc.en.taoism.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.en.taoism.layers.dao.movements.MovementsDao;
import com.sc.en.taoism.layers.dao.pictures.PicturesDao;
import com.sc.en.taoism.layers.dao.presentations.PresentationsDao;
import com.sc.en.taoism.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.en.taoism.layers.dao.quotes.QuotesDao;
import com.sc.en.taoism.layers.dao.quotes.QuotesDaoInterface;
import com.sc.en.taoism.layers.dao.urls.UrlsDao;
import com.sc.en.taoism.layers.dao.urls.UrlsDaoInterface;
import com.sc.en.taoism.layers.dao.accounts.AccountsDao;
import com.sc.en.taoism.layers.dao.accounts.AccountsDaoInterface;
import com.sc.en.taoism.layers.dao.authors.AuthorsDaoInterface;
import com.sc.en.taoism.layers.dao.books.BooksDao;
import com.sc.en.taoism.layers.dao.movements.MovementsDaoInterface;
import com.sc.en.taoism.layers.dao.pictures.PicturesDaoInterface;
import com.sc.en.taoism.layers.dao.themes.ThemesDao;
import com.sc.en.taoism.layers.dao.themes.ThemesDaoInterface;
