package com.sc.en.bouddhism.layers.dao;

import com.sc.en.bouddhism.layers.dao.accounts.AccountsDaoInterface;
import com.sc.en.bouddhism.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.en.bouddhism.layers.dao.movements.MovementsDaoInterface;
import com.sc.en.bouddhism.layers.dao.quotes.QuotesDao;
import com.sc.en.bouddhism.layers.dao.urls.UrlsDao;
import com.sc.en.bouddhism.layers.dao.authors.AuthorsDao;
import com.sc.en.bouddhism.layers.dao.books.BooksDaoInterface;
import com.sc.en.bouddhism.layers.dao.centuries.CenturiesDao;
import com.sc.en.bouddhism.layers.dao.movements.MovementsDao;
import com.sc.en.bouddhism.layers.dao.pictures.PicturesDao;
import com.sc.en.bouddhism.layers.dao.presentations.PresentationsDao;
import com.sc.en.bouddhism.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.en.bouddhism.layers.dao.quotes.QuotesDaoInterface;
import com.sc.en.bouddhism.layers.dao.urls.UrlsDaoInterface;
import com.sc.en.bouddhism.layers.dao.accounts.AccountsDao;
import com.sc.en.bouddhism.layers.dao.authors.AuthorsDaoInterface;
import com.sc.en.bouddhism.layers.dao.books.BooksDao;
import com.sc.en.bouddhism.layers.dao.pictures.PicturesDaoInterface;
import com.sc.en.bouddhism.layers.dao.themes.ThemesDao;
