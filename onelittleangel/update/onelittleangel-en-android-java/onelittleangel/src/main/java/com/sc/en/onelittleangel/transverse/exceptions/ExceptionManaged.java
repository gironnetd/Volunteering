 ...
 * *****************************************************************************************************************</br>
 */
package com.sc.en.onelittleangel.transverse.exceptions;
...
//	}
	 ...
	 */
//	public ExceptionManaged(Class rootClass, Exception exc) {
//		this(rootClass, loadMessage(ExceptionManaged.NO_ERROR_MESSAGE_ID), ExceptionManaged.NO_ERROR_MESSAGE_ID, exc);
//	}
...
//	}
	 ...
	 */
//	public ExceptionManaged(Class rootClass, Throwable throwable) {
//		this(rootClass, loadMessage(ExceptionManaged.NO_ERROR_MESSAGE_ID), ExceptionManaged.NO_ERROR_MESSAGE_ID, throwable);
//	}
	...
	private static String loadMessage(int errorMessageId) {
		if (errorMessageId != NO_ERROR_MESSAGE_ID) {
			return OnelittleAngelApplication.instance.getResources().getString(errorMessageId);
		} else {
			return "no error";
		}
	}
