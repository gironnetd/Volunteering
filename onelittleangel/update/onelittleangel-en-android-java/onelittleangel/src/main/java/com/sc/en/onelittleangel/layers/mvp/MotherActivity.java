package com.sc.en.onelittleangel.layers.mvp;
...
import com.sc.en.onelittleangel.transverse.eventbus.events.ErrorEvent;
import com.sc.en.onelittleangel.transverse.eventbus.events.ExceptionManagedEvent;
...
public abstract class MotherActivity extends AppCompatActivity {
  ...
  protected void onStart() {
    ...
    OnelittleAngelApplication.instance.onStartActivity();
    //register for eventBus
    EventBus.getDefault().register(this);
    EventBus.getDefault().register(getPresenter());
    manageConnectivityStatus(OnelittleAngelApplication.instance.isConnected());
  }
  ...
  protected void onStop() {
    ...
    OnelittleAngelApplication.instance.onStopActivity();
   ...
   *  Managing Presenters
   **********************************************************/
  protected abstract MotherPresenter getPresenter();
