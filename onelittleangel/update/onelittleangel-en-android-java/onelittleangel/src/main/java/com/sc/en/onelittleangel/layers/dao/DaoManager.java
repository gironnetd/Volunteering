package com.sc.en.onelittleangel.layers.dao;

import com.sc.en.onelittleangel.layers.dao.accounts.AccountsDaoInterface;
import com.sc.en.onelittleangel.layers.dao.centuries.CenturiesDaoInterface;
import com.sc.en.onelittleangel.layers.dao.movements.MovementsDao;
import com.sc.en.onelittleangel.layers.dao.movements.MovementsDaoInterface;
import com.sc.en.onelittleangel.layers.dao.pictures.PicturesDao;
import com.sc.en.onelittleangel.layers.dao.pictures.PicturesDaoInterface;
import com.sc.en.onelittleangel.layers.dao.presentations.PresentationsDao;
import com.sc.en.onelittleangel.layers.dao.presentations.PresentationsDaoInterface;
import com.sc.en.onelittleangel.layers.dao.quotes.QuotesDao;
import com.sc.en.onelittleangel.layers.dao.quotes.QuotesDaoInterface;
import com.sc.en.onelittleangel.layers.dao.themes.ThemesDao;
import com.sc.en.onelittleangel.layers.dao.themes.ThemesDaoInterface;
import com.sc.en.onelittleangel.layers.dao.urls.UrlsDaoInterface;
import com.sc.en.onelittleangel.layers.dao.accounts.AccountsDao;
import com.sc.en.onelittleangel.layers.dao.authors.AuthorsDao;
import com.sc.en.onelittleangel.layers.dao.authors.AuthorsDaoInterface;
import com.sc.en.onelittleangel.layers.dao.books.BooksDao;
import com.sc.en.onelittleangel.layers.dao.books.BooksDaoInterface;
import com.sc.en.onelittleangel.layers.dao.centuries.CenturiesDao;
import com.sc.en.onelittleangel.layers.dao.urls.UrlsDao;
