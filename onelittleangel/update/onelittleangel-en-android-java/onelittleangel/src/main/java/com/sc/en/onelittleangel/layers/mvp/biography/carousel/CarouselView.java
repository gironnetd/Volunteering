package com.sc.en.onelittleangel.layers.mvp.biography.carousel;
...
public class CarouselView extends CarouselSpinner implements GestureDetector.OnGestureListener {
     ...
     */
    private final FlingRotateRunnable mFlingRunnable = new FlingRotateRunnable();
     ...
     */
    private final CarouselOptions mCarouselOptions;
    ...
    private final OnClickListener mEmptyClickListener = v -> {
        // Do nothing
    };
     ...
     */
    private void addView(View childView, OnClickListener action) {
    ...
    private void scrollToChild(int idx) {
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
        ...
        ArrayList<CarouselItemHolder> sl = new ArrayList<>();
    ...
    private Matrix getChildTransformationMatrix(final CarouselItemHolder item,
    ...
    private ViewCoefficientHolder getViewCoefficient() {
        ...
        return new ViewCoefficientHolder(CarouselConfigInfo.DIAMETER_SCALE * dpiScale,
    ...
    private void addViewToList(View childView, OnClickListener onClickListener) {
        ...
        carouselItem.setLayoutParams(new RelativeLayout.LayoutParams(childView.getWidth(), childView.getHeight()));
    ...
    private void setMatrixToCarouselHolder(final CarouselItemHolder item, final Matrix matrix) {
    ...
    private static class ViewCoefficientHolder {
        ...
        private ViewCoefficientHolder(float diameterScale, float tilt) {
    ...
    private class FlingRotateRunnable implements Runnable {
        ...
        private void startUsingDistance(float deltaAngle) {
            ...
            mLastFlingAngle = 0;
            mRotator.startRotate(-deltaAngle, mCarouselOptions.getAnimationDuration());
            post(this);
        }
    ...
    private void drawCarouselPanel(Canvas canvas, View carouselPanel) {
        ...
        paint.setAlpha((int) (carouselPanel.getAlpha() * 255.0f));
    ...
    private void setCarouselDrawingPanelsEnabled(boolean enable) {
        ...
        for (int childIndex = 0; childIndex < getChildCount(); childIndex++) {
            View childView = getChildAt(childIndex);
            childView.setVisibility(enable ? INVISIBLE : VISIBLE);
