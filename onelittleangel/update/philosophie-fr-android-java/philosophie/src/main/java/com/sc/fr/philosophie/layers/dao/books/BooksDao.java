package com.sc.fr.philosophie.layers.dao.books;
...
// get first object from results at position randomly generated above
  ...
  @Override
  public List<Book> findAllBooksFromMainMovement() {
    Realm realm = Realm.getDefaultInstance();
